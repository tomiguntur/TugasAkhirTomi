...
import com.tomiguntur.ProjectAkhir.Shoes.Adapter.CartAdapter;
...
//                                reseting the quantities of shoes once order is placed.
                firestore.collection("Shoees").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    @Override
                    public void onComplete(Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
